...
def help_handler(app: Client) -> None:
    ...
    async def _help(client: Client, message: Message):
        ...
        text = (
            ...
            "Bot kya karta hai?\n"
            "• Google Drive / TeraBox / Direct downloadable links se files download karke Telegram par send karta hai.\n"
            "• Multiple links ek sath bhejoge to queue me 1-by-1 process hoga.\n"
            "• Downloading + Uploading progress bar + ETA show hota hai (8 sec edit interval).\n"
            ...
            "• Topics wale groups me same topic/thread me hi files bheji jayengi.\n\n"
            "Commands:\n"
            "/start  - Introduction + buttons\n"
            "/help   - Ye guide\n"
            "/cancel - Ongoing queue/task cancel\n"
            ...
            "Notes:\n"
            "• Agar koi link fail ho, end me Failed count + reasons log me aa jayenge.\n"
        )
